...
#define MSPROF_REPORT_AICPU_HCCL_OP_INFO            10U /* task信息 hccl_op_info */
#define MSPROF_REPORT_AICPU_FILP_TASK               11U /* flip 翻转 task */
#define MSPROF_REPORT_AICPU_HCCL_FLAG_TASK          12U /* aicpu 展开 hccl 主流首尾task */
