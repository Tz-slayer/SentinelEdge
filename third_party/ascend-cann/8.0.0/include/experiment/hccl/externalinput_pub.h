...
constexpr u32 HCCL_INVALIED_IF_BASE_PORT = 65536;  // HCCL 默认无效端口号
...
struct MasterInfo {
    ...
    u32 port = HCCL_INVALIED_IF_BASE_PORT;
...
void SetIfProfile(bool ifOpbase, bool state);
...
const bool& GetExternalInputHcclIfProf();
