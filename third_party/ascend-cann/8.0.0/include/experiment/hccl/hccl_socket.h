...
constexpr u32 HOST_SOCKET_CONN_LIMIT = HCCL_AISERVER_DEVICE_NUM; // 用于host socket建链白名单，限制每个server的socket连接数
...
public:
    ...
    explicit HcclSocket(HcclNetDevCtx netDevCtx, u32 localPort);
