 ...
 */
TraHandle AtraceCreate(TracerType tracerType, const char *objName) __attribute((weak));
 ...
 * @return      atrace handle
 */
TraHandle AtraceCreateWithAttr(TracerType tracerType, const char *objName, const TraceAttr *attr) __attribute((weak));
 ...
 * @return      atrace handle
 */
TraHandle AtraceGetHandle(TracerType tracerType, const char *objName) __attribute((weak));
 ...
 * @return      TraStatus
 */
TraStatus AtraceSubmit(TraHandle handle, const void *buffer, uint32_t bufSize) __attribute((weak));
 ...
 * @return      NA
 */
void AtraceDestroy(TraHandle handle) __attribute((weak));
 ...
 * @return      TraStatus
 */
TraStatus AtraceSave(TracerType tracerType, bool syncFlag) __attribute((weak));

void *AtraceStructEntryListInit(void) __attribute((weak));
void AtraceStructEntryName(TraceStructEntry *entry, const char *name) __attribute((weak));
...
void AtraceStructEntryExit(TraceStructEntry *entry) __attribute((weak));
 ...
 * @return      TraStatus
 */
TraStatus AtraceSubmitByType(TraHandle handle, uint8_t bufferType,
 ...
 */
TraceStructEntry *AtraceStructEntryCreate(const char *name) __attribute((weak));
 ...
 * @return          NA
 */
void AtraceStructEntryDestroy(TraceStructEntry *en) __attribute((weak));
 ...
 * @return          NA
 */
void AtraceStructItemFieldSet(TraceStructEntry *en, const char *item,
 ...
 * @return          NA
 */
void AtraceStructItemArraySet(TraceStructEntry *en, const char *item,
    uint8_t type, uint8_t mode, uint16_t len) __attribute((weak));
 ...
 * @return          NA
 */
void AtraceStructSetAttr(TraceStructEntry *en, uint8_t type, TraceAttr *attr) __attribute((weak));
 ...
 * @return      TraStatus
 */
TraStatus AtraceReportStart(int32_t devId) __attribute((weak));
 
 /**
 * @brief       stop thread to receive device trace log
 * @param [in]  devId:         device id
 */
void AtraceReportStop(int32_t devId) __attribute((weak));
 ...
 * @return      event handle
 */
TraEventHandle AtraceEventCreate(const char *eventName) __attribute((weak));
 ...
 * @return      event handle
 */
TraEventHandle AtraceEventGetHandle(const char *eventName) __attribute((weak));
 ...
 * @return      NA
 */
void AtraceEventDestroy(TraEventHandle eventHandle) __attribute((weak));
 ...
 * @return      TraStatus
 */
TraStatus AtraceEventBindTrace(TraEventHandle eventHandle, TraHandle handle) __attribute((weak));
 ...
 * @return      TraStatus
 */
TraStatus AtraceEventSetAttr(TraEventHandle eventHandle, const TraceEventAttr *attr) __attribute((weak));
 ...
 * @return      TraStatus
 */
TraStatus AtraceEventReport(TraEventHandle eventHandle) __attribute((weak));
