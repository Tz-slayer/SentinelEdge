 ...
 * @since
 */
ADX_API int32_t AdumpAddExceptionOperatorInfo(const OperatorInfo &opInfo);
 ...
 * @since
 */
ADX_API void *AdumpGetSizeInfoAddr(uint32_t space, uint32_t &atomicIndex);
 ...
 * @since
 */
ADX_API void *AdumpGetDFXInfoAddrForDynamic(uint32_t space, uint64_t &atomicIndex);
 ...
 * @since
 */
ADX_API void *AdumpGetDFXInfoAddrForStatic(uint32_t space, uint64_t &atomicIndex);
